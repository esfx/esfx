...
import { isOrderedIterable, isOrderedHierarchyIterable, isHierarchyIterable } from './internal/guards';
import { ConsumeOptions } from './types';
import { OrderedIterable } from "./ordered";
import { Page, HierarchyPage } from './page';
import { Grouping, HierarchyGrouping } from './grouping';
import { Lookup } from './lookup';
import { HierarchyIterable, HierarchyProvider, Hierarchical, OrderedHierarchyIterable } from './hierarchy';
...
export function from<TNode, T extends TNode>(source: Iterable<T>, provider?: HierarchyProvider<TNode>): any {
    ...
    return source instanceof Query ? source :
        isOrderedHierarchyIterable(source) ? new OrderedHierarchyQuery(source) :
