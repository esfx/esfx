...
export declare class CancelToken implements Cancelable, CancelSignal {
    /**
     * A CancelToken that can never be signaled.
     */
    static readonly none: CancelToken;
    /**
     * A CancelToken that starts signaled.
     */
     ...
     */
    readonly canBeSignaled: boolean;
    /**
     ...
     */
    static race(cancelables: Iterable<Cancelable>): CancelToken;
    /**
     * Returns a CancelToken that becomes signaled when **all** of the provided cancelables are signaled.
     * @param cancelables An iterable of Cancelable objects.
     */
    static all(cancelables: Iterable<Cancelable>): CancelToken;
    /**
